		...
		<div class="container clearfix">
			...
			<div class="footer-nav__col footer-nav__col--contacts">
				...
				<address class="address">
					Head Office: Empower Store.<br>
					Jalan Jababeka, Indonesia.
				</address>
				<div class="phone">
					Telephone:
					<a class="phone__number" href="tel:0123456789">081389045318</a>
				</div>
				<div class="email">
					Email:
					<a href="mailto:support@yourwebsite.com" class="email__addr">empowerstore@gmail.com</a>
				</div>
			</div>
