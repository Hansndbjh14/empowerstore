...
if (isset($_POST['add_cart'])) {
  ...
  // Ambil harga asli produk dari tabel products
  $get_price = "SELECT product_price FROM products WHERE product_id='$p_id'";
  $run_price = mysqli_query($con, $get_price);
  $row_price = mysqli_fetch_array($run_price);
  $product_price = $row_price['product_price']; // Harga asli dari produk
  ...
  if (mysqli_num_rows($run_check) > 0) {
      ...
      // Masukkan produk ke dalam keranjang belanja dengan harga asli dan diskon null
      $query = "INSERT INTO cart (p_id, ip_add, qty, p_price, size, price_asli, diskon) VALUES ('$p_id', '$ip_add', '$product_qty', '$product_price', '$product_size', '$product_price', NULL)";
